...
NUMERICAL_NA_NOT_ALLOWED = [feature for feature in FEATURES 
						if feature not in NUMERICAL_VARS_WITH_NA + CATEGORICAL_VARS]

CATEGORICAL_NA_NOT_ALLOWED = [feature for feature in CATEGORICAL_VARS 
